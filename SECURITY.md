...
- **GitHub Security Advisories** — [open a private report](https://github.com/semitexa/semitexa-orm/security/advisories/new).
...
In scope: anything in `semitexa/orm` that lets a request, a job or a message do
