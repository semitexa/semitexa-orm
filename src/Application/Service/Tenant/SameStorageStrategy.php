...
namespace Semitexa\Orm\Application\Service\Tenant;

use Semitexa\Orm\Domain\Contract\ColumnInjectingScopeInterface;
...
final class SameStorageStrategy implements TenantScopeInterface, ColumnInjectingScopeInterface
{
